...
public class ExercicioIV2 {
	...
	public static void main(String[] args) {
		...
		String discPares[] = new String[5];

		System.out.println("Array pares:");
		for (int index = 0; index < disciplinas.length; index++) {
			if (index % 2 != 0) {
				
				discPares[index] = disciplinas[index];
				
		}
			
		// impressão das discPares
			
		for(int index1 = 0; index1 < discPares.length; index1++) {
			System.out.println(disciplinas[index1]);
		}
